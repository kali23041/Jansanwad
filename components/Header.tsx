    ...
    <>
      ...
      <div className="bg-indigo-900 text-white text-xs py-1 px-4 hidden md:flex justify-between items-center">
        <div className="flex items-center space-x-4">
          <div className="flex items-center">
            ...
            <span className="header-text">+91 1234567890</span>
          </div>
          <div className="flex items-center">
            <Mail className="w-3 h-3 mr-1" />
            <span className="header-text">info@jansanwadnews.in</span>
          </div>
        </div>
      ...
      <div className="bg-indigo-900 text-white flex items-center">
        <div className="flex items-center p-2">
          ...
          <span className="text-xs header-text">{currentDate}</span>
        </div>
        <div className="bg-red-400 text-white px-4 py-2 font-medium breaking-news-text text-sm">Breaking News</div>
        <div className="flex-1 overflow-hidden whitespace-nowrap px-4 py-2">
          <span className="inline-block animate-marquee news-ticker text-sm">
      ...
      <div className="bg-indigo-900 text-white sticky top-0 z-10">
        <div className="max-w-7xl mx-auto flex justify-between items-center px-4 py-2 overflow-x-auto">
          <div className="flex space-x-6">
            <Link href="#" className="nav-link whitespace-nowrap hover:text-red-300 transition-colors">
              राष्ट्रीय
            </Link>
            <Link href="#" className="nav-link whitespace-nowrap hover:text-red-300 transition-colors">
              राजकारण
          ...
          <Button variant="ghost" className="text-white hidden md:flex header-text">
