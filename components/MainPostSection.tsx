  ...
  return (
    <div className="md:col-span-2">
      <article className="bg-white border border-gray-200 p-6 rounded-xl shadow-md">
        {/* Breadcrumb */}
        <nav className="flex items-center text-sm text-gray-500 mb-5 pb-3 border-b border-gray-100">
        ...
        <div className="flex space-x-2 mb-5">
          <Badge className="bg-indigo-900 hover:bg-indigo-800 text-white px-3 py-1 text-xs rounded-full transition-colors shadow-sm">
            राष्ट्रीय
          </Badge>
          <Badge className="bg-indigo-900 hover:bg-indigo-800 text-white px-3 py-1 text-xs rounded-full transition-colors shadow-sm">
            शैक्षणिक
        ...
        {/* Article Title */}
        <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-5 leading-tight">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 pb-5 border-b border-gray-100">
          <div className="flex items-center">
            ...
            <div>
              <div className="font-medium text-gray-900">Team Jansanwad</div>
        ...
        <figure className="mb-8 rounded-xl overflow-hidden shadow-lg">
          ...
          />
          <figcaption className="text-sm text-gray-500 mt-3 italic px-2">
        ...
        <div className="prose prose-lg max-w-none prose-indigo mb-8">
          <p className="font-medium text-gray-900 text-xl leading-relaxed mb-5">
          ...
          <blockquote className="border-l-4 border-indigo-500 pl-4 py-2 italic bg-indigo-50 rounded-r-md my-6">
            "विज्ञान शिक्षणात प्रात्यक्षिक अनुभव हा महत्त्वाचा भाग आहे. या सायन्स लॅबमुळे विद्यार्थी संशोधक बनण्याचा मार्ग मोकळा होईल." 
            <cite className="block text-right not-italic text-sm text-gray-600 mt-2">- प्रा. शब्बीर नालबंद</cite>
          </blockquote>
        </div>

        {/* Tags */}
        <div className="mt-6 mb-8 flex flex-wrap gap-2">
          <Badge variant="outline" className="bg-gray-100 hover:bg-gray-200 transition-colors px-3 py-1 rounded-full">
            सायन्स लॅब
          </Badge>
          <Badge variant="outline" className="bg-gray-100 hover:bg-gray-200 transition-colors px-3 py-1 rounded-full">
            शिक्षण
        ...
        <div className="mt-10 mb-8 bg-gradient-to-r from-indigo-50 to-gray-50 p-6 rounded-xl shadow-sm border border-indigo-100">
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4">
            ...
            <div>
              <h3 className="font-bold text-lg text-gray-900 mb-2">Team Jansanwad</h3>
        ...
        {/* Related Articles */}
        <div className="mt-12">
          <h2 className="text-xl font-bold mb-6 text-gray-800 border-b pb-2">संबंधित बातम्या</h2>
            ...
            <Link href="#" className="group">
              <div className="border rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <div className="p-4">
                  ...
                  <h3 className="font-medium text-gray-900 group-hover:text-indigo-900 transition-colors line-clamp-2">
